...
- Cathedrals of Error now caches normalized ray directions, uses an allocation-free scalar marcher, and keeps a near-native 95% internal raster with a bounded 10-step beat-load march (8 on Low) while retaining full idle detail; local Chrome rehearsal measured 12.5ms p95 with Demo active, within the 16.7ms target. This remains empirical local evidence until the named-device rehearsal.
