...
- The round Start audio control now starts the local Demo beat when no source is active and preserves connected file, microphone, or tab audio; its pressed state and label make the current source explicit.
