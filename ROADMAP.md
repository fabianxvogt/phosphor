...
- Expression/CPPN breeding: structural mutations beyond the current harmonic-outline genome.
- Genuine hyperbolic tilings: validate one {5,4} chamber before generalizing.
- Low/mid/high audio mapping and onset envelopes with bounded smoothing; do not advertise BPM detection prematurely.
- A scene mixer with two independently rendered sources, blend modes and per-layer opacity, after measuring its resource budget. Current effects compose one source.
