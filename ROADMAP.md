...
- Cathedrals of Error now applies a bounded reusable luma edge pass and high-quality display enlargement after its source raster, improving local edge definition without increasing ray-march work; validate the result on the named reference device before raising its raster budget.
