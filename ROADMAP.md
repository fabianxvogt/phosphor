...
- Julia quality A/B summaries now show the actual renderer backing dimensions and the output canvas together (for example, `CPU 640×400→960×600`), keeping Focus compositing legible in the rehearsal card as well as the saved report.
