...
- Cathedrals of Error now caches normalized ray directions, uses an allocation-free scalar marcher, and keeps a sharper 70% internal raster with a bounded 12-step beat-load march (10 on Low) while retaining full idle detail; local Chrome rehearsal measured 14.4ms p95 with Demo active, within the 16.7ms target. This remains empirical local evidence until the named-device rehearsal.
