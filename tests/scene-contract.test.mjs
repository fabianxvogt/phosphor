...
test('new family renderers keep fixed bounded resources in source', () => {
  ...
  assert.match(html, /id="demoAudioButton"[^>]*aria-pressed="false"[^>]*aria-describedby="audioStatus beatReadout beatNextReadout audioCoverageReadout audioHeadroomReadout(?: audioSessionReadout)?(?: audioBeatTelemetryReadout)? audioSourceHistoryReadout"/, 'demo source announces its state, current/next beat, coverage, headroom, run, onset telemetry, and source history');
  assert.match(html, /id="audioFileInput"[^>]*aria-describedby="audioStatus beatReadout beatNextReadout audioCoverageReadout audioHeadroomReadout(?: audioSessionReadout)?(?: audioBeatTelemetryReadout)? audioSourceHistoryReadout"/, 'file source references its status, current/next beat, coverage, headroom, run, onset telemetry, and source history');
